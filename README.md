...
1. **폴더 구조**
   - 자신의 이름으로 된 폴더를 생성합니다. 예: `hyunsoo`, `jihye` 등.
   - 자신의 폴더 안에 주제별로 폴더를 생성하여 코드를 관리합니다. 예: `hyunsoo/variables`, `jihye/control_flow` 등.

2. **코드 작성 및 커밋**
   - 작성한 코드는 자신의 폴더 안에 저장합니다.
   - 커밋 메시지는 간결하고 명확하게 작성합니다. 예: `Add variable examples`, `Fix loop bug in control flow`.

3. **풀 리퀘스트(Pull Request)**
   - 풀 리퀘스트를 통해 코드를 제출합니다.
   - 풀 리퀘스트 제목은 작업 내용을 간략히 설명합니다. 예: `[hyunsoo] 변수 예제 추가`.
